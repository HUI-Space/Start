...
namespace Start
{
    public partial class UIAction : IGenericData
    {
        ...
        {
            UIAction uiAction = RecyclablePool.Acquire<UIAction>();
    ...
    public partial class UIAction
    {
        ...
        public UIAction SetData<T1>(T1 data1)
        {
            ...
            _data = RecyclablePool.Acquire<GenericData<T1>>().SetData(data1);
            return this;
        }
        ...
        public UIAction SetData<T1, T2>(T1 data1, T2 data2)
        {
            ...
            _data = RecyclablePool.Acquire<GenericData<T1, T2>>().SetData(data1, data2);
            return this;
        }
        ...
        public UIAction SetData<T1, T2, T3>(T1 data1, T2 data2, T3 data3)
        {
            ...
            _data = RecyclablePool.Acquire<GenericData<T1, T2, T3>>().SetData(data1, data2, data3);
            return this;
        }
        ...
        public UIAction SetData<T1, T2, T3, T4>(T1 data1, T2 data2, T3 data3, T4 data4)
        {
            ...
            _data = RecyclablePool.Acquire<GenericData<T1, T2, T3, T4>>().SetData(data1, data2, data3, data4);
            return this;
        }
        ...
        public UIAction SetData<T1, T2, T3, T4, T5>(T1 data1, T2 data2, T3 data3, T4 data4, T5 data5)
        {
            ...
            _data = RecyclablePool.Acquire<GenericData<T1, T2, T3, T4, T5>>().SetData(data1, data2, data3, data4, data5);
            return this;
        }
        ...
        public UIAction SetData<T1, T2, T3, T4, T5, T6>(T1 data1, T2 data2, T3 data3, T4 data4, T5 data5, T6 data6)
        {
            ...
            _data = RecyclablePool.Acquire<GenericData<T1, T2, T3, T4, T5, T6>>().SetData(data1, data2, data3, data4,
                data5, data6);
            return this;
        }
    }
