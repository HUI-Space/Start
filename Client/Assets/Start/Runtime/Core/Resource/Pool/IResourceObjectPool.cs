...
namespace Start
{
    ...
    public interface IResourceObjectPool<TObject, TTarget> : IResourceObjectPoolBase 
        where TObject : ResourceObjectBase<TTarget>, new() 
        where TTarget : class
    {
        /// <summary>
        ...
        void Initialize(int capacity = Int32.MaxValue, bool allowMultiSpawn = false, float autoReleaseInterval = float.MaxValue, float expireTime = float.MaxValue, int priority = 0);
