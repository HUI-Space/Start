...
namespace Start.Runtime
{
    public class LoadResourceAgent : ITaskAgent<LoadResourceBaseTask>
    {
        ...
        public EStartTaskStatus Start(LoadResourceBaseTask task)
        {
            ...
            {
                fullPath = ResourceHelper.GetResourcePath(resourceInfo.ResourceType, resourceInfo.Name);
        ...
        private void OnLoadResourceComplete(object resource)
        {
        ...
        private void LoadAsset(object resource)
        {
