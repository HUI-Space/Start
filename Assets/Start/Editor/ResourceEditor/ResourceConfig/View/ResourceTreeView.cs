...
namespace Start.Editor.ResourceEditor
{
    public partial class ResourceTreeView : TreeView
    {
        ...
        private ObjectPool<ResourceTreeViewItem> _objectPool = new ObjectPool<ResourceTreeViewItem>();
        ...
        protected override TreeViewItem BuildRoot()
        {
            ...
            {
                string[] paths = EditorUtility.FindAssets(SearchType.All, resourceGroupItem.Path);
