...
namespace Start.Editor.ResourceEditor
{
    ...
    public class Resource
    {
        ...
        /// 直接依赖
        /// </summary>
        public HashSet<string> DirectDependencies => _directDependencies ?? (_directDependencies = EditorUtility.GetDependencies(Path, false));

        /// <summary>
        /// 所有依赖
        /// 包括直接依赖和间接依赖
        /// </summary>
        public HashSet<string> AllDependencies => _allDependencies ?? (_allDependencies = EditorUtility.GetDependencies(Path));
